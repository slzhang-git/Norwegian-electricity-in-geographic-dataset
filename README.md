...
**Dataset description:** A detailed description of our dataset is available via our paper published by _IEEE Data Descriptions_ ([link to the paper](https://doi.org/10.1109/IEEEDATA.2026.3658039)).

**Download:** Our dataset can be directly downloaded from Zenodo [here](https://doi.org/10.5281/zenodo.16794603). We store the dataset in Zenodo due to the limited storage quato in Github.
...
```text
@article{11364211,
  title={Descriptor: Norwegian Electricity in Geographic Dataset (NoreGeo)},
  author={Zhang, Shiliang and Maharjan, Sabita and Strunz, Kai and Bryne, Jan Christian},
  journal={IEEE Data Descriptions},
  pages={82-92},
  volume={3},
  doi={10.1109/IEEEDATA.2026.3658039},
  year={2026}
}
```
